<div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Rental Multimedia Equipment</h1>
            <div class="mt-2">
                <span class="text-gray-500">Sewa / Products List</span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    <h2 class="text-lg font-semibold mb-4">Rent Your Equipment</h2>
                    <form class="mt-6 space-y-6" wire:submit="submit" method="POST">
                        ...
                        <!-- Start Rent -->
                        <div>
                            <label for="start_rent" class="block text-sm font-medium text-gray-700">
                                Tanggal Mulai Sewa
                            </label>
                        ...
                        <!-- End Rent -->
                        <div>
                            <label for="end_rent" class="block text-sm font-medium text-gray-700">
            ...
            <div class="lg:col-span-3">
                <div class="flex justify-between items-center mb-6">
                    <span class="text-gray-600">{{ count($items) }} Showing</span>
                </div>
                    ...
                    @foreach ($items as $item)
                        <div class="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col h-full">
                            ...
                            <div class="p-4 flex flex-col flex-grow">
                                ...
                                <div class="h-8">
                                    <p class="text-gray-600 text-xs">Professional Mirrorless Camera</p>
                                </div>

                                <!-- Price Container -->
                                <div class="mt-auto pt-4">
                                    <span class="text-sm font-bold">{{ number_format($item->price_per_day, 2) }}/day</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
