...
<nav x-data="{ open: false }" class="bg-stone-100 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:flex">
                ...
                @auth
                    <x-nav-link :href="route('sewa')" :active="request()->routeIs('sewa')" wire:navigate>
                        {{ __('Sewa') }}
                    </x-nav-link>
                @else
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('sewa')" :active="request()->routeIs('sewa')" wire:navigate>
                {{ __('Sewa') }}
            </x-responsive-nav-link>
